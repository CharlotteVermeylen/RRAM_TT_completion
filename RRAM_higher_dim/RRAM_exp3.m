% This script generates the third experiment in the manuscript with the
% RRAM (section 4.3.1).
...
%%
figure
t = tiledlayout(3,4, 'Padding', 'none', 'TileSpacing', 'compact'); 
