% This script generates the fourth experiment in the manuscript with the
% RRAM (section 4.3.1).
...
%%
p = nexttile;
plot(ranks(:,5),'b-+','Markersize',8,'Linewidth',2);
hold on
plot(ranks2(:,5),'r-o','Markersize',8,'Linewidth',2);
axis tight
...
%%
p = nexttile;
plot(ranks(:,6),'b-+','Markersize',8,'Linewidth',2);
hold on
plot(ranks2(:,6),'r-o','Markersize',8,'Linewidth',2);
axis tight
